...
public class MapTest implements MapInterface
{
	private final static int NB_ENNEMIES 			= 1;
	...
	int[][] map = new int[][]
	{ 
		{ BT | BL | 0 ,  BT | 0           , BT| BB | 0  , BT | BB | 0 ,  BB  |0       ,  BB | BT | 0    ,  BB | BT | 0   , BT | BB | 0  ,  BT | BB | 0       ,  BT | BR | 0  },
		{ BL | BR | 0 ,  BL | BB | 0      , BB| BT | 0  , BT | BB | 0 ,  BB | BT | 0  ,  BT | BB | SS    ,  BT |  BB | HB  , BT | BB | 0   ,  BT | BR | 0       ,  BL | BR | 0  },
		{ BL | BR | 0 ,  BL | BT | BB | SB , BB| BT | HE  , BT | BB | 0  ,  BB | BT | 0  ,  BT      | HP    ,  BT |  BB | HP  , BT | BB | 0  ,  BB | BR | 0       ,  BL | BR | 0  },
		{ BL | 0      ,  BT | BB | 0 | 0 , BB| BT | 0  , BT | BB      ,  BB | BT | 0  ,  BB      | 0    ,  BT |  BB | 0   , BT | BB | SM  ,  BT | BR | 0       ,  BL | BR | 0  },
		{ BL | HB      ,  BT | BB | 0      , BT | 0      , BT | BB | 0 ,  BB | BT | 0  ,  BT | BB | 0    ,  BT |  BB | 0  , BT | BB | 0  ,  BB | BR | 0       ,  BL | BR | 0  },
		{ BR | 0      ,  BL | BB | BT | 0 , BB | 0      , BT | BB | 0 ,  BB | BT | SB  ,  BT | BB | 0    ,  BT | 0        , BT | BB | 0  ,  BT | BB | 0       , 0          },
		{ BL | BR | 0 ,  BL | BT | BB | 0 , BT | 0      , BT | BB | 0 ,  BB | BT | 0  ,  BT | BB | 0     ,  BB | 0        , BT | BB | 0  ,  BT | BB | BR | HB  ,  BL | BR | 0  },
		{ BL | BR | 0 ,  BL | BT | BB | 0 , BB | 0      , BT | 0      ,  BB | BT | 0  ,  BT | BB | 0     ,  BT |  BB | 0  , BT | BB | 0   ,  BT | BB | BR | SB  ,  BL | BR | 0  },
		{ BL | BR | 0 ,  BL | BT | BB | SS , BB| BT | 0  , BB | 0      ,  BB | BT | 0  ,  BT | BB | 0    ,  BT |  BB | 0   , BT | BB | 0  ,  BT | BR | 0        ,  BL | BR | 0  },
		{ BL | BR | 0 ,  BL | BT | BB| SM  , BB| BT | 0   , BT | BB | 0 ,  BT      | 0  ,  BT | BB | 0    ,  BT |  BB | 0   , BT | BB | 0   ,  BB | BR | 0       ,  BL | BR | HB  },
		{ BL | BB | 0 ,  BT | BB | 0      , BB| BT | 0  , BT | BB | 0 ,  0            ,  BT | BB | 0    ,  BT | BB  |0   , BT | BB | 0  ,  BT | BB | 0       ,  BR | BB | 0  },
	};
